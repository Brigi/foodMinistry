...
public class RecipesPoolUtil {

    public static final String BASE_URL = ServerUtil.HOST_ROOT_URL + "user/recipespool";
    
    public static HttpResponse addRecipe(long userId, long recipesPoolId, String recipeName, Map<Long, Float> ingredientsWithAmount, String recipeDescription) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException, ExecutionException {
        return sendPutRequest(new AddRecipeJSON(userId, recipesPoolId, recipeName, ingredientsWithAmount, recipeDescription));
    }
    
    public static HttpResponse getRecipes(long userId, long recipesPoolId) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException, ExecutionException {
        return sendGetRequest(new GetRecipesJSON(userId, recipesPoolId));
    }
