...
/**
 * This class represents all available {@link Ingredient}s and serves as an entity to retrieve templates of {@link Ingredient}s.
 * Hence each {@link Ingredient} in this pool is unique.
...
public class IngredientsPool {
     ...
     * @throws IngredientNotFoundException Thrown if there exists no ingredient in this pool with the given name
     */
    ...
    /**
     * Adds the given ingredient to this pool. If the ingredient is already present in this pool, nothing happens.
    ...
    /**
     * Removes the given ingredient from the pool. If the ingredient did not exist, nothing happens.
