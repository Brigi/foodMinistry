...
/**
 * This class represents the household of the user. It contains all elements needed for this application to work and serves as entry point 
 * to apply actions on the different entities the user got. This actions can for example be adding supply to the food storage, cooking recipes,
 * adding ingredients to the shopping list and etc..
 *  
...
public class Household extends PersistenceObject {
    ...
    /**
     * Constructor initializing this class. It accepts a name to which this household should 
     * be associated.
     ...
     * household
     * @param recipes The set of recipes to add
     */
    ...
    /**
     * Removes the given recipes from the current set of recipes available in 
     * this household
