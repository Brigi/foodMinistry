...
public abstract class Util {
    ...
    /**
     * Adds the given ingredient with the given quantity to the given map. If the ingredient is already present, then 
     * the quantity gets added to the already existing quantity in the map. Is the quantity reduced to 0 or below, then the 
     * ingredient will be removed from the given map.
     * @param map A map containing ingredients with their quantity. This map get altered in this method
