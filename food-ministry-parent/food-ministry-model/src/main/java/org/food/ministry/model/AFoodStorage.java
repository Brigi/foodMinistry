...
/**
 * This is an abstract class representing any storage of food. It contains {@link Ingredient}s with a certain quantity, which can be altered 
 * by any action the user takes.
 * 
...
public abstract class AFoodStorage extends PersistenceObject {
    ...
    /**
     * Adds the given {@link Ingredient} with the given quantity to this food storage. A negative quantity will 
     * reduce the current quantity by the amount. Once the quantity of an {@link Ingredient} reaches 0 or less the 
    ...
    /**
     * Returns a String with all contained {@link Ingredient}s and their quantity plus the associated Unit to that {@link Ingredient}.
     * The list of {@link Ingredient} is sorted by name.
     * <br>E.g.: <i>"Tomato: 1<br>Sugar: 2 kg<br>Salt: 1 tsp."</i>
     * 
     * @return a String with all contained {@link Ingredient}s and their quantity plus the associated Unit to that {@link Ingredient}.
     */
