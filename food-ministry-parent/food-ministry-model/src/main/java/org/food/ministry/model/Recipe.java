...
/**
 * This class represent a recipe of the user. It contains a list of {@link Ingredient}s and the needed quantity needed to cook this recipe. 
...
public class Recipe {
    ...
    /**
     * Gets a map containing the needed ingredients for this recipe associated with the quantity
     * @return A map containing the needed ingredients for this recipe associated with the quantity
     */
    ...
    /**
     * Sets a map containing the needed ingredients for this recipe associated with the quantity
     * @param ingredients A map containing the needed ingredients for this recipe associated with the quantity
     */
