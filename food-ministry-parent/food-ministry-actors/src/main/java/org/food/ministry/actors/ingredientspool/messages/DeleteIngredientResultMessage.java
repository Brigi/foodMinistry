...
/**
 * The message for transmitting the result of an attempt to delete an ingredient.
 * 
 * @author Maximilian Briglmeier
 * @since 22.02.2019
 */
public class DeleteIngredientResultMessage extends AResultMessage {
     ...
     */
    public DeleteIngredientResultMessage(long id, long originId, boolean successful, String errorMessage) {
