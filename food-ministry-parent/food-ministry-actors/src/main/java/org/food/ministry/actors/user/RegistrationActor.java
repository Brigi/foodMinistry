...
public class RegistrationActor extends AbstractActor {
     ...
     *            registering a user
     */
    private void register(RegisterMessage registerMessage) {
        String emailAddress = registerMessage.getEmailAddress();
        ...
        try {
            ...
            getSender().tell(new RegisterResultMessage(IDGenerator.getRandomID(), registerMessage.getId(), true, Constants.NO_ERROR_MESSAGE), getSelf());
            ...
            getSender().tell(new RegisterResultMessage(IDGenerator.getRandomID(), registerMessage.getId(), false, errorMessage), getSelf());
        }
    }
